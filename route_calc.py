...
def calculate_full_route(origin, destinations):
    ...
    all_combo_routes, total_combo_distances, smallest_index = calculate_best_combos(destinations, point_a, point_b, two_point_distance, origin_to_point_dict, point_to_origin_dict)
...
def calculate_best_combos(destinations, point_a, point_b, two_point_distance, origin_to_point_dict, point_to_origin_dict):
